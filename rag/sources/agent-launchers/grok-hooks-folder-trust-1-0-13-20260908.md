---
title: "Grok 1.0.13のhookとフォルダ信頼"
source_url: "file:///Users/kite/.grok/docs/user-guide/10-hooks.md"
source_type: local_vendor_docs
fetched: 2026-09-08
topic: agent-launchers
tags: ["grok", "hooks", "trust"]
summary: "Grok配布資料の原文。プロジェクトhook、MCP、LSPの信頼を公式--trustで登録する仕様。"
relevance: "確度: 公式配布資料と実機で確認。Aitermの無人起動がフォルダ信頼画面で初回promptを失う問題の根拠。"
chars: 48507
---
