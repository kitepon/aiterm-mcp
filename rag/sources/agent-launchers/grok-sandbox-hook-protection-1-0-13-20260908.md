---
title: "Grok 1.0.13のsandboxとhookパス保護"
source_url: "file:///Users/kite/.grok/docs/user-guide/18-sandbox.md"
source_type: local_vendor_docs
fetched: 2026-09-08
topic: agent-launchers
tags: ["grok", "sandbox", "symlink"]
summary: "Grok配布資料の原文。read-only sandboxの書込制限と、hook sourceのsymlinkを拒否する仕様。"
relevance: "確度: Direct global hook write protection節を実機で確認。hook設定の配布者が実ファイルを置き、Aitermがsandboxを変更しない責務境界の根拠。"
chars: 17697
---
