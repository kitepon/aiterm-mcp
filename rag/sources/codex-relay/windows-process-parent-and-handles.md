---
title: "UpdateProcThreadAttribute: 親processと継承handleの指定"
source_url: "https://raw.githubusercontent.com/MicrosoftDocs/sdk-api/docs/sdk-api-src/content/processthreadsapi/nf-processthreadsapi-updateprocthreadattribute.md"
source_type: official_docs
fetched: 2026-09-13
topic: codex-relay
tags: ["windows", "process", "codex", "stdio"]
summary: "公式processを起動元の直接の子として起動し、指定したstdio handleだけを引き継ぐためのWindows標準API。"
relevance: "Macと共通の起動・中継構成をWindowsへ適合させる根拠。"
chars: 34845
---
