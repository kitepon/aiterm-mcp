---
title: "Claude Code Channels: 起動条件と順番待ち"
source_url: "https://code.claude.com/docs/en/channels.md"
source_type: official_docs
fetched: 2026-09-10
topic: completion-detection
tags: ["claude-code", "channels", "parent-delivery"]
summary: "Claude Codeの公式Channelsによる既存親へのpush受信。有効化・組織policy・対応認証を説明する。"
relevance: "Claude親への自動配送の正規受信口と導入条件を決める。"
chars: 23837
---
