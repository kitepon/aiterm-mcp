---
title: "Claude Code Channels reference: MCP通知契約"
source_url: "https://code.claude.com/docs/en/channels-reference.md"
source_type: official_docs
fetched: 2026-09-10
topic: completion-detection
tags: ["claude-code", "mcp", "channels"]
summary: "claude/channel capabilityとnotifications/claude/channelを規定する。通知ACKはなく、有効化されていない親は通知を黙示破棄する。"
relevance: "通知書込みと受領を区別し、親の識別・有効化・切断時の契約を検証する。"
chars: 50246
---
