---
title: "Claude Code hooks: asyncRewakeと非ブロック受信"
source_url: "https://code.claude.com/docs/en/hooks.md"
source_type: official_docs
fetched: 2026-09-10
topic: completion-detection
tags: ["claude-code", "hooks", "asyncRewake", "parent-delivery"]
summary: "command hookのexec形式、PreToolUse/PostToolUse/SessionEndとasyncRewakeの公式契約。asyncRewakeはバックグラウンドで動き、exit 2でidle中の親も再開する。"
relevance: "起動flagを増やさずClaude親へ結果を届け、MCP requestのtoolUseIdとhookのtool_use_idで宛先を相関する。"
chars: 319948
---
