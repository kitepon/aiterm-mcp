---
title: "Codex 0.154.0: MCP要求へのthreadId付与"
source_url: "https://raw.githubusercontent.com/openai/codex/rust-v0.154.0/codex-rs/core/src/mcp_tool_call.rs"
source_type: source_code
fetched: 2026-09-10
topic: completion-detection
tags: ["codex", "parent-delivery", "confirmed-source"]
summary: "モデルからのMCP呼出しに正規threadIdを_metaとして加える。ソース確認済み。"
relevance: "親モデルに宛先IDを入力させず、依頼単位で配送先を固定する。"
chars: 84041
---
