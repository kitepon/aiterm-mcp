---
title: "Codex 0.154.0: 外部キュー監視と待機中ターンの開始"
source_url: "https://raw.githubusercontent.com/openai/codex/rust-v0.154.0/codex-rs/ext/queue/src/service.rs"
source_type: source_code
fetched: 2026-09-10
topic: completion-detection
tags: ["codex", "parent-delivery", "confirmed-source"]
summary: "共有storeの変更監視と待機中threadへの配送、実行中threadの次ターン処理を所有する。ソース確認済み。"
relevance: "CLIとDesktopで共通の受信・再開処理。受信待ちと割込みを区別する根拠。"
chars: 21232
---
