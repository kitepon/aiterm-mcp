---
title: "Codex 0.154.0: 既存セッションへのキュー投入"
source_url: "https://raw.githubusercontent.com/openai/codex/rust-v0.154.0/codex-rs/tui/src/session_queue_commands.rs"
source_type: source_code
fetched: 2026-09-10
topic: completion-detection
tags: ["codex", "parent-delivery", "confirmed-source"]
summary: "公式codex queueはthread/queue/addへ要求し、宛先UUIDと本文を渡す。ソース確認済み。"
relevance: "親を別processでresumeせず、公開受信キューへ回答を渡す実装根拠。"
chars: 5132
---
