---
title: "HomebrewのCellarとopt prefix"
source_url: "https://docs.brew.sh/Manpage"
source_type: docs
fetched: 2026-09-19
topic: installation
tags: ["homebrew", "node", "setup"]
summary: "Cellarは版別の実体を置き、opt prefixは有効なkegへのsymlinkを維持する。"
relevance: "NodeのMCP登録とCodex中継を、同じformulaの更新後も有効なoptパスへ保存する根拠。"
chars: 134990
---

![Homebrew Documentation logo](https://brew.sh/assets/img/homebrew.svg)
...
[![Fork me on GitHub](https://brew.sh/assets/img/forkme_right_gray_6d6d6d.svg)](https://github.com/Homebrew/brew)
