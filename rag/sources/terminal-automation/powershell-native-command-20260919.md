---
title: "PowerShell: Windows実行形式の判定と関連付け起動"
source_url: "https://raw.githubusercontent.com/PowerShell/PowerShell/master/src/System.Management.Automation/engine/NativeCommandProcessor.cs"
source_type: official_source
fetched: 2026-09-19
topic: terminal-automation
tags: ["powershell", "windows", "PATHEXT", "stdio"]
summary: "WindowsではPATHEXTで直接実行を判定し、関連付け起動では標準入出力のredirectを使わない。"
relevance: "隔離Codex hook試験のPATHEXT欠落でNodeが別窓に残った原因を照合する一次資料。"
chars: 104301
---
