...
`, { mode: 0o600 });
  ...
  const runtime = { socket_path: socketPath };
  await verifyCodexParent(destination, runtime);
  const steered = await submitCodexParentAnswer(destination, '11111111-2222-4333-8444-555555555555', 'AITERM_RELAY_ACTIVE', runtime);
  assert.equal(steered.queued_submission_id, null);
  ...
  await submitCodexParentAnswer(destination, '11111111-2222-4333-8444-666666666666', 'AITERM_RELAY_LATE', runtime);
